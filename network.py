...
class LSTMModel(nn.Module):
    ...
    def __init__(self,
        ...
        if using_pretrained:
            ...
            self.embedding_layer.weight.data.copy_(torch.from_numpy(vocab.vectors))
...
class TextCNN(nn.Module):
    def __init__(self, vocab:Vocab, train_embedding_word_dim, is_static, using_pretrained,
        ...
        if using_pretrained:
            ...
            self.embedding_pre.weight.data.copy_(torch.from_numpy(vocab.vectors))
            self.embedding_pre.weight.requires_grad = not is_static
        print(self.embedding_pre.weight.data)
        print(self.word_dim)
