...
config_device = torch.device('cuda:1')
parser = argparse.ArgumentParser()
parser.add_argument('--dataset', choices=config_dataset_list, default='IMDB')
parser.add_argument('--model', choices=config_model_lists, default='LSTM')
parser.add_argument('--epoch', type=int, default=100)
parser.add_argument('--enhanced', type=parse_bool, choices=[True, False], default='yes')
...
train_data.token2seq(vocab, maxlen)
